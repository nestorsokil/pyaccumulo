...
from accumulo.ttypes import IteratorSetting, IteratorScope
...
class GrepIterator(BaseIterator):
    ...
    def __init__(self, term, negate=False, priority=10, name="GrepIterator"):
        super(GrepIterator, self).__init__(name=name, priority=priority,
...
class RegExFilter(BaseIterator):
    ...
    def __init__(self, row_regex=None, cf_regex=None, cq_regex=None, val_regex=None, or_fields=False,
                 match_substring=False, priority=10, name="RegExFilter"):
        super(RegExFilter, self).__init__(name=name, priority=priority,
